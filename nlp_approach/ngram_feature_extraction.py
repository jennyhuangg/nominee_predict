'''
Converts files of confirmation text hearings into vectorized counts of 1-grams.
...
pickle.dump(vectorizer.get_feature_names(), open("data/ngrams/1grams_names.p", "wb"))
